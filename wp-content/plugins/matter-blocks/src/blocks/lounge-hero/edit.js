...
/**
 * Editor del blocco matter/lounge-hero.
 *
        ...
        <>
            <InspectorControls>
                <PanelBody title={ __( 'Testi', 'matter-blocks' ) } initialOpen={ true }>
                    ...
                    />
                    <TextControl
                        label={ __( 'Accent Word', 'matter-blocks' ) }
                        value={ attributes['accent-word'] || '' }
                        onChange={ ( v ) => setAttributes( { 'accent-word': v } ) }
                    />
                    <TextareaControl
                    ...
                    />
                    <TextareaControl
                        label={ __( 'Whisper', 'matter-blocks' ) }
                        value={ attributes['whisper'] || '' }
                        onChange={ ( v ) => setAttributes( { 'whisper': v } ) }
                    />
                </PanelBody>
            ...
            <div { ...blockProps }>
                <ServerSideRender block="matter/lounge-hero" attributes={ attributes } />
            </div>
        </>
    );
}
