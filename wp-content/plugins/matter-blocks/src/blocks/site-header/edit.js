            ...
            <InspectorControls>
                <PanelBody title={ __( 'Link', 'matter-blocks' ) } initialOpen={ false }>
                    ...
                    <LinkControl
                        ...
                        hasRichPreviews={ false }
                    />
                    <p className="components-base-control__label">{ __( 'Link 18', 'matter-blocks' ) }</p>
                    <LinkControl
                        value={ {
                            url: attributes['link-18']?.url || '',
                            title: attributes['link-18']?.label || '',
                            opensInNewTab: attributes['link-18']?.target === '_blank'
                        } }
