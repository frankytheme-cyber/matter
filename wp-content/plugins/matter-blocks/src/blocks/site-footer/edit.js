    ...
    return (
        <>
            ...
            <RichText
                ...
                placeholder={ __( 'brand-text…', 'matter-blocks' ) }
            />
            <RichText
                tagName="h4"
                value={ attributes.heading }
                onChange={ ( v ) => setAttributes( { heading: v } ) }
                placeholder={ __( 'heading…', 'matter-blocks' ) }
            />
            <RichText
                tagName="p"
                value={ attributes.text }
                onChange={ ( v ) => setAttributes( { text: v } ) }
                placeholder={ __( 'text…', 'matter-blocks' ) }
            />
            <RichText
                tagName="a"
            ...
            <RichText
                ...
                placeholder={ __( 'heading-2…', 'matter-blocks' ) }
            />
            <RichText
                tagName="p"
                value={ attributes['text-2'] }
                onChange={ ( v ) => setAttributes( { 'text-2': v } ) }
                placeholder={ __( 'text-2…', 'matter-blocks' ) }
            />
            <RichText
                tagName="a"
            ...
            <RichText
                ...
                placeholder={ __( 'heading-3…', 'matter-blocks' ) }
            />
            <RichText
                tagName="a"
            ...
            <RichText
                ...
                placeholder={ __( 'heading-4…', 'matter-blocks' ) }
            />
            <RichText
                tagName="a"
